...
metadata = RtaMetadata(
    ...
    platforms=["windows"],
    endpoint_rules=[{'rule_id': 'cc35ee3e-d350-4319-b7f3-ea0d991ce4d9', 'rule_name': 'Suspicious Impersonation as Trusted Installer'}],
    siem_rules=[],
    techniques=["T1134"],
)
...
def impersonate_trusted_installer():
    try:
        ...
        new_tokenh = win32security.DuplicateTokenEx(th, 2, _common.TOKEN_ALL_ACCESS , win32security.TokenImpersonation , win32security.SECURITY_ATTRIBUTES())
