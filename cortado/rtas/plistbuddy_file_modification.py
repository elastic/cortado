...
def main():
    ...
    _ = _common.execute_command([masquerade, "testRunAtLoad testLaunchAgentstest"], timeout_secs=10, kill=True)
    _ = _common.execute_command([masquerade, "testProgramArgumentstest"], timeout_secs=10, kill=True)
