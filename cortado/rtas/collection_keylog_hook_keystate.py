...
metadata = RtaMetadata(
    ...
    platforms=["windows"],
    endpoint_rules=[
        RuleMetadata(id="2ed0570d-3fa4-45b1-b4f2-d7fcc827daf1", name="Suspicious Input Capture via GetAsyncKeyState API"),
        RuleMetadata(id="be7140ba-4633-46a7-ac59-91cc85e5e252", name="GetAsyncKeyState API Call from Suspicious Process"),
        RuleMetadata(id="7ae180e1-e08f-40c2-82db-f274f688eea2", name="keystroke Messages Hooking via SetWindowsHookEx"),
        RuleMetadata(id="6ef43c9a-25af-449c-8416-20349780a146", name="Keystrokes Input Capture from Suspicious CallStack"),
    ],
    siem_rules=[],
